...
while True:
    while sensorBlue.reflection() < 15:  # Is robot on a path
        robot.drive(200, 0)
        ...
        if sensorRed.reflection() < 15 and sensorYellow.reflection() < 15:
            ...
            if choice == 0:
                print('straight')
                robot.drive_time(speed_d, 0, speed_t)
                i += 1
            if choice == 1:
                print('right')
                turnRight()
